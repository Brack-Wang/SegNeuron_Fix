...
def post_mc(affs, beta=0.25):
    ...
    watershed = np.zeros_like(boundary_input, dtype='uint16')
    offset = 0
...
if __name__ == "__main__":
    root_path = '/data/wangfeiran/code/brainbow/segmentation/SegNeuron/data/brainbow/test/test6'
    aff_root = root_path + '/neuron.npy'
    bound_root = root_path + '/neuron.tif'
    gt_root = root_path + '/label.tif'
    beta = 0.25
    ...
    imageio.volwrite(root_path + '/pred.tif', pred_seg.astype(gt_seg.dtype))
